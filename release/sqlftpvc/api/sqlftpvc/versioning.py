...
def next_version_no(project_id: str) -> str:
...
def commit_script(project_id: str, script_id: str, content: bytes, message: str) -> CommitResult:
    paths = get_paths()
    version_id = str(uuid.uuid4())
    version_no = next_version_no(project_id=project_id)
